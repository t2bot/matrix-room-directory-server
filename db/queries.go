...
var queries = map[string]string{
	selectAllRooms: "SELECT room_id, canonical_alias, name, topic, avatar_url, joined_count, world_readable, guests_can_join FROM listed_rooms ORDER BY joined_count DESC;",
